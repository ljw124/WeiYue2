package com.dcdz.weiyue.webview;
...
import com.dcdz.weiyue.MainActivity;
...
import com.dcdz.weiyue.webview.config.FullscreenHolder;
import com.dcdz.weiyue.webview.config.IWebPageView;
import com.dcdz.weiyue.webview.config.ImageClickInterface;
import com.dcdz.weiyue.webview.config.MyWebChromeClient;
import com.dcdz.weiyue.webview.config.MyWebViewClient;
...
public class WebViewActivity extends AppCompatActivity implements IWebPageView {
    ...
    public static void loadUrl(Context mContext, String mUrl, String mTitle) {
        if (NetUtil.isNetworkAvailable(mContext)) {
            ...
            ToastUtil.showShort(MyApp.getContext(), "当前网络不可用，请检查你的网络设置");
        }
    }
