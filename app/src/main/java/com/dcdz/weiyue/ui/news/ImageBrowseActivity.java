...
import com.dcdz.weiyue.widget.HackyViewPager;
import com.dcdz.weiyue.widget.MyScrollView;
import com.dcdz.weiyue.widget.SwipeBackLayout;
...
public class ImageBrowseActivity extends BaseActivity<ArticleReadPresenter> implements ArticleReadContract.View {
    ...
    SwipeBackLayout mSwipeBackLayout; //滑动返回

    public static void launch(Activity context, NewsDetailBean.ItemBean bodyBean) {
