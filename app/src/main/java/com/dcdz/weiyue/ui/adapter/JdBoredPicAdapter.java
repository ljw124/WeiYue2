...
import com.dcdz.weiyue.ui.jandan.view.ImageBrowseActivity;
...
import com.dcdz.weiyue.widget.MultiImageView;
import com.dcdz.weiyue.widget.ShowMaxImageView;
 ...
 * desc: 煎蛋——无聊图
 */
public class JdBoredPicAdapter extends BaseMultiItemQuickAdapter<JdDetailBean.CommentsBean, BaseViewHolder> {
    private static final String TAG = "JdBoredPicAdapter";
    private Activity mContext;

    public JdBoredPicAdapter(Activity context, @Nullable List<JdDetailBean.CommentsBean> data) {
        super(data);
